...
class TaskyProScreen < Calabash::ABase
  ...
  def is_checked(task_name)
    # This is a verbose query - we first find the TextView holding our task name,
    # then we look for the parent layout which should be LinearLayout. The ImageView
    # holding the check mark is a sibling to this LinearLayout. We can
